...
SDK families, OpenAPI authorities, route manifests, and generated SDK artifacts for the `sdkwork-canvas` repository.

Authority: `../sdkwork-specs/SDK_SPEC.md`, `../sdkwork-specs/SDK_WORKSPACE_GENERATION_SPEC.md`.

## Active SDK Families

- `sdkwork-canvas-app-sdk/`: generated app-api SDK (consumer-facing, authenticated).
- `sdkwork-canvas-backend-sdk/`: generated backend-api SDK (admin/operator surface).
