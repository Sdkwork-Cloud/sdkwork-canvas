# SDKWork Canvas Types Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-types` |
| Type | `node-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-types` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-types typecheck`
