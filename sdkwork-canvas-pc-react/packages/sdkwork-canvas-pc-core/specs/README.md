# SDKWork Canvas Core Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-core`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-core` |
| Type | `react-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-core` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-core typecheck`
