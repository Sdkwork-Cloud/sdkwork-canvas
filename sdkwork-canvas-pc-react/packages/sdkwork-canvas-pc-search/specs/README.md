# SDKWork Canvas Search Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-search`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-search` |
| Type | `node-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-search` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-search typecheck`
