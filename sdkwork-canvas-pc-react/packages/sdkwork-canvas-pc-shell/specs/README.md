# SDKWork Canvas Shell Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-shell` |
| Type | `react-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-shell` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-shell typecheck`
