...
fn route_manifest_matches_app_openapi_operations() {
    ...
    let expected_operations = BTreeSet::from([
        ...
        "GET /app/v3/api/canvas/boards/{boardId}".to_string(),
        "PATCH /app/v3/api/canvas/boards/{boardId}".to_string(),
        "POST /app/v3/api/canvas/boards/{boardId}/remote_apply".to_string(),
        "GET /app/v3/api/canvas/boards/{boardId}/content".to_string(),
        "PUT /app/v3/api/canvas/boards/{boardId}/content".to_string(),
        "GET /app/v3/api/canvas/boards/{boardId}/versions".to_string(),
        "POST /app/v3/api/canvas/boards/{boardId}/versions/{driveVersionId}/restore".to_string(),
        "GET /app/v3/api/canvas/boards/{boardId}/ai_suggestions".to_string(),
