# SDKWork Canvas Local Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-local`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-local` |
| Type | `node-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-local` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-local typecheck`
