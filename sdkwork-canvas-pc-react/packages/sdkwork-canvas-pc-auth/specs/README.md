# SDKWork Canvas Auth Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-auth`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-auth` |
| Type | `react-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-auth` |
| Domain | `iam` |
| Capability | `auth` |
...
- `pnpm --filter @sdkwork/canvas-pc-auth typecheck`
