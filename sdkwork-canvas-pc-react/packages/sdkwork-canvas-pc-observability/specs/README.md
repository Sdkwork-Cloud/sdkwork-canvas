# SDKWork Canvas Observability Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-observability`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-observability` |
| Type | `node-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-observability` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-observability typecheck`
