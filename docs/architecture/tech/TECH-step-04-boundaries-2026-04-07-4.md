...
- 责任：
  ...
  - 命令面板条目模型组装
- 当前文件：
  - `packages/sdkwork-canvas-canvas/src/services/noteWorkspaceSelectors.ts`
  - `packages/sdkwork-canvas-canvas/src/services/noteWorkspaceCommandPaletteModel.ts`
- 当前说明：
  ...
  - selector 现已统一产出：
    ...
    - 命令面板 actions / views / folders / canvas descriptors
