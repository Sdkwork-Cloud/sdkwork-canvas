# SDKWork Canvas PC React Component Specs

This directory is the local standards index for `sdkwork-canvas-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-canvas-pc-react` |
| Type | `react-tauri-app` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react` |
| Domain | `content` |
| Capability | `canvas` |
