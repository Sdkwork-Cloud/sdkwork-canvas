import { createServiceAdapterController } from '@sdkwork/canvas-pc-commons';
import type { Note, NoteSummary, PageRequest, ServiceResult } from '@sdkwork/canvas-pc-types';
import {
  noteRepository,
  type NoteRepository,
} from '../repository/noteRepository';
import type { NoteWorkspaceSnapshot } from '../types/canvasWorkspace';
