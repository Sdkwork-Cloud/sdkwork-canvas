# SDKWork Canvas Sync Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-sync`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-sync` |
| Type | `node-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-sync` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-sync typecheck`
