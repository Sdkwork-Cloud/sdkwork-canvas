# SDKWork Canvas I18n Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-i18n` |
| Type | `react-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-i18n` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-i18n typecheck`
