# SDKWork Canvas Notes Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-canvas`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-canvas` |
| Type | `react-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-canvas` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-canvas typecheck`
