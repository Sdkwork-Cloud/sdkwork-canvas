-- SDKWork canvas consolidated initialization baseline (postgres)
...
-- baseline source: ddl/baseline/postgres/0001_canvas_legacy_baseline.sql
-- Consolidated legacy baseline for sdkwork-canvas database module.
-- source: crates/sdkwork-canvas-pages-repository-sqlx/src/sqlite_core.sql
