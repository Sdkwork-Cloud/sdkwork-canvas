...
This README is the SDKWork module entrypoint for `sdkwork-canvas-pc-react`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../sdkwork-specs/`.
...
- `pnpm --filter @sdkwork/canvas-pc-react typecheck`
