...
- `sdkwork-canvas-pc-react/packages/sdkwork-canvas-canvas/src/services/noteWorkspaceSaveFeedback.ts`
  - 新增 `buildNotesWorkspaceSaveFeedbackModel()`
  - 新增 `resolveNotesWorkspaceSaveRequestState()`
  - 新增 `resolveNotesWorkspaceSaveSuccessState()`
- `sdkwork-canvas-pc-react/packages/sdkwork-canvas-canvas/src/types/canvasWorkspace.ts`
...
- `sdkwork-canvas-pc-react/packages/sdkwork-canvas-canvas/src/components/NoteEditorPane.tsx`
...
- `sdkwork-canvas-pc-react/packages/sdkwork-canvas-canvas/src/components/NotesWorkspaceErrorBanner.tsx`
  - 支持 retry CTA

### 2.3 契约层与文案层

- `sdkwork-canvas-pc-react/scripts/workspace-save-feedback.contract.test.mjs`
  - 新增保存失败反馈与重试状态机 contract
- `sdkwork-canvas-pc-react/scripts/workspace-page-error-banner-boundary.contract.test.mjs`
  - 升级为验证 retry CTA
