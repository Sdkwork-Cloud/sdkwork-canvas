# SDKWork Canvas Desktop Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-desktop`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-desktop` |
| Type | `react-tauri-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-desktop` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-desktop typecheck`
