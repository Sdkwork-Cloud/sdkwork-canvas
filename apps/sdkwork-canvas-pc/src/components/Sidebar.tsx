...
export function Sidebar({ activeSection, activeSubSection, onSelect }: SidebarProps) {
  return (
    <aside className="canvas-scrollbar flex w-60 shrink-0 flex-col gap-5 overflow-y-auto border-r border-gray-200 bg-white px-3 py-5 dark:border-neutral-800 dark:bg-neutral-900">
