...
- `sdkwork-canvas-pc-react/scripts/workspace-search-query.contract.test.mjs`

该 contract 冻结以下事实：

1. `canvas-search` 必须提供统一查询函数。
...
1. `canvas-search` 已具备统一查询 API，不再只是 schema 占位层。
