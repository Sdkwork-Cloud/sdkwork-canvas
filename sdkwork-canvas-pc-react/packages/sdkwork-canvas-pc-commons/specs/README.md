# SDKWork Canvas Commons Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-commons` |
| Type | `react-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-commons` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-commons typecheck`
