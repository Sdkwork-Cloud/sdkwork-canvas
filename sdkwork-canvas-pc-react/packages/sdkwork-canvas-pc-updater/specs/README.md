# SDKWork Canvas Updater Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-updater`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-updater` |
| Type | `node-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-updater` |
| Domain | `content` |
| Capability | `canvas` |
...
- `pnpm --filter @sdkwork/canvas-pc-updater typecheck`
