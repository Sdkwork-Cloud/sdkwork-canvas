# SDKWork Canvas User Component Specs

This directory is the local standards index for `@sdkwork/canvas-pc-user`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/canvas-pc-user` |
| Type | `react-package` |
| Root | `sdkwork-canvas/sdkwork-canvas-pc-react/packages/sdkwork-canvas-pc-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter @sdkwork/canvas-pc-user typecheck`
